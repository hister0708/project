...
<body>
	...
	<img src="범죄도시.jpg" alt="범죄도시" width="300" height="auto" /> </div2>
	<h3>좌석을 선택하시오</h3>
	<form method=get action="CTProcess">
		...
		<input type="radio" name="seat" value="A2"> 2번 좌석 <input
			...
			type="radio" name="seat" value="A10"> 10번 좌석 <br> B열 <br>
		<input type="radio" name="seat" value="B1"> 1번 좌석 <input
			...
			type="radio" name="seat" value="B10"> 10번 좌석 <br> C열 <br>
		<input type="radio" name="seat" value="C1"> 1번 좌석 <input
			...
			type="radio" name="seat" value="C10"> 10번 좌석 <br> D열 <br>
		<input type="radio" name="seat" value="D1"> 1번 좌석 <input
			...
			type="radio" name="seat" value="D10"> 10번 좌석 <br> E열 <br>
		<!-- 이미지 들어감 (가운데 정렬) -->
		<input type="radio" name="seat" value="E1"> 1번 좌석 <input
			...
			type="radio" name="seat" value="E10"> 10번 좌석 <br> <input
			type="submit" value="결제하기" class="submit-button"
			onclick="setActions()"> <input type="hidden" value="" id="action" name="action">
			<input type="hidden" value="" id="action_select" name="action_select">
	</form>
